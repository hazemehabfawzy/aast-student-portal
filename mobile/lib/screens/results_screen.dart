...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  Color _getGradeColor(String? grade) {
    ...
    if (grade.startsWith('C')) return const Color(0xFFFFC107); // Yellow
    if (grade.startsWith('D')) return const Color(0xFFFF9800); // Orange
    if (grade == 'F') return const Color(0xFFF44336);           // Red
    return Colors.grey;
  }
                                 ...
                                 children: [
                                   ...
                                   Row(
                                     ...
                                     children: [
                                       ...
                                       _buildScoreCol('C.Work', r['prefinalScore']),
